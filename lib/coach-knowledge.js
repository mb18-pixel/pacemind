/**
 * Wissenschaftlich fundierte Trainingsprinzipien für den Ascend-Coach.
...
export const sportArten = {
  laufen: {
    name: "Laufen",
    einheit: "km",
    trainingstypen: ["Locker", "Tempo", "Intervall", "Langer Lauf", "Regeneration"],
  },
  radfahren: {
    name: "Radfahren",
    einheit: "km",
    laufäquivalent: 0.3,
    klassifizierung: "Locker/Tempo je nach Intensität",
    hinweis: "30km Rad ≈ 10km Laufbelastung",
  },
  schwimmen: {
    name: "Schwimmen",
    einheit: "m",
    laufäquivalent: 0.4,
    klassifizierung: "Technik oder Ausdauer",
  },
  crosstrainer: {
    name: "Crosstrainer",
    einheit: "Min",
    laufäquivalent: 0.7,
    klassifizierung: "Locker oder Tempo",
  },
  fussball: {
    name: "Fußball",
    einheit: "Min",
    laufäquivalent: 0.6,
    klassifizierung: "Intervall",
    hinweis: "Sprints + Richtungswechsel = Intervallbelastung",
  },
  krafttraining: {
    name: "Krafttraining",
    einheit: "Min",
    laufäquivalent: 0.2,
    klassifizierung: "Ergänzung",
    hinweis: "Stärkt Rumpf und Beine, Verletzungsprävention",
  },
  yoga: {
    name: "Yoga/Dehnen",
    einheit: "Min",
    laufäquivalent: 0.1,
    klassifizierung: "Regeneration",
    hinweis: "Fördert Beweglichkeit und Erholung",
  },
};
